...
grch37.genes.5k$chrom.arm <- gr.5k$chrom.arm[gr.5k.grch37.genes$queryHits]
grch37.genes.5k
## write it out
...
grch37.genes.20k$chrom.arm <- gr.20k$chrom.arm[gr.20k.grch37.genes$queryHits]
grch37.genes.20k
...
## copy arm from other object
grch37.genes.50k$chrom.arm <- grch37.genes.20k$chrom.arm
grch37.genes.50k
