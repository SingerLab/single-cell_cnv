...
bsub -J fqs_${bioID} -n 8 -M 8 -W 89 ./src/qc_scripts/01_1.fastp.sh $fastq_dir $EXTENSION
bsub -J fqs_${bioID}[1-$nn]%100 -n 8 -M 8 -W 89 ./src/qc_scripts/01_1.fastp.sh $fastq_dir $EXTENSION
